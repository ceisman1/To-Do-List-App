...
function CreateToDoItems() {
  if (todoValue.value === "") {
    ...
    const todoItems = `<div title="Hit Double Click and Complete" ondblclick="CompletedToDoItems(this)">${todoValue.value}</div><div>
                    <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="Images/edit-icon.png" />
                    <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="Images/delete-icon.png" /></div></div>`;
...
function UpdateToDoItems(e) {
  if (
    ...
    addUpdate.setAttribute("src", "Images/refresh-icon.png");
    todoValue.focus();
  }
}
...
function CompletedToDoItems(e) {
  if (e.parentElement.querySelector("div").style.textDecoration === "") {
    ...
    img.src = "Images/check-mark.png.png";
